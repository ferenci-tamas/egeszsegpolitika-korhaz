...
res <- readRDS(url("https://github.com/ferenci-tamas/korhaz-agyszam-betegforgalom-halalozas/raw/refs/heads/main/ferenci-tamas-korhaz-agyszam-betegforgalom.rds"))
...
Röviden érintem az ágyszámkihasználás és az átlagos ápolási idő kérdését is.
...
A felhasznált forrásadatok -- valamint az előállításuk részletei -- a már említett projektem [oldalán](https://github.com/ferenci-tamas/korhaz-agyszam-betegforgalom-halalozas) teljes részletességgel megtalálhatóak. Az adatgyűjtés technikai megoldása miatt -- illetve mert amúgy is ez volt most a fókuszomban -- az egész elemzés kizárólag az aktív ellátásokra vonatkozik.
...
A dolog sok kommentárt nem igényel (érdemes azt is megnézni, hogy mennyire szépen megjelenik a szocialista örökség máshol is, illetve, hogy mennyire fals az a kép, hogy a magas ágyszám automatikusan azt jelenti, hogy jobb a helyzet -- amit elvileg jelent az az hozzáállás, ami szerint az ágyszám-csökkentés automatikusan rossz). _Még most is_ a lista első felében vagyunk.
...
Egyszóval, ha minden amerikai tisztában lenne a helyzettel, akkor ez a korlátozás valószínűleg egy napot nem élne túl -- csakhogy nem ez a helyzet. És egy dolgot hadd hangsúlyozzak: nem azért, mert az emberek "buták", "tudatlanok" vagy "érdektelenek", sőt, bizonyos szempontból teljesen racionális a viselkedésük, hiszen 30 dollárért _tényleg_ nem éri meg még csak a tájékozódásba sem ölni túl nagy energiát, nem hogy a tiltakozásba. Azaz: nagyon eltérő a felek érdekeltsége a szituációban.
