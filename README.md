...
Néhány esetben az Eurostat által gyűjtött adatokat használtam (a magyar
...
másik lehetőséget: tekintsük át az időbeli trendeket is! Először nézzük
az országos összesített adatot:
...
látszik, hogy e haladás nagy részét 1980 és 2010 között értük el. Azóta
nem nagyon sikerült változtatni; szolgáljon vigaszul, hogy a fenti ábra
szerint ez másoknak sem ment sokkal jobban Európában… (Vegyük
figyelembe, hogy azért a dolognak van egy orvosi minimuma.)

Nézzük most a helyzetet kórházanként és szakmánként. Az alábbi ábrán
minden halvány vonal egy kórház adata, a vastag piros pedig az országos
átlag az adott szakmában:
...
mondanivalóm illusztrálása szempontjából ez mindegy is.)
...
„buták”, „tudatlanok” vagy „érdektelenek”, sőt, bizonyos szempontból
teljesen racionális a viselkedésük, hiszen 30 dollárért *tényleg* nem
éri meg még csak a tájékozódásba sem ölni túl nagy energiát, nem hogy a
...
tesz (itt vannak például az ajánlásaik a
[pitvarfibrillációtól](https://academic.oup.com/eurheartj/article/41/10/1132/5717382)
a
[tüdőrákig](https://erj.ersjournals.com/content/erj/48/3/852.full.pdf)).
...
magyarázattal ellátott vizualizációk, idősoros grafikonok, letölthető az
– egy évre előre megadott – [adatközlési
...
vastagbél-rák audit [oldalát](https://www.natcan.org.uk/audits/bowel/),
részletes tájékoztatók orvosoknak, betegeknek; [így néz
ki](https://www.natcan.org.uk/wp-content/uploads/2025/10/NBOCA-State-of-the-Nation-Report-2025.pdf)
...
sebészeti technikák megoszlása és így tovább, és így tovább. És ez még
csak egy rák-típus volt…! Elérhető [hasonló
oldal](https://www.natcan.org.uk/) egy sor más rák-típushoz is. Minden
pontnál ajánlások, és [külön
rovat](https://www.natcan.org.uk/quality-improvement/) a
...
indikátort](https://ime.memt.hu/cikk/2011/egeszseg-gazdasagtani-kulonszam-2011/az-interneten-elerheto-minosegugyi-informaciok-szerepe-a-betegtajekoztatasban-tanulsagok-a-minosegi-indikatorrendszer-eddigi-mukodese-alapjan/)
...
érkeznek az intézményükbe. Emlékszem még milyen lejárató cikkeket
írattak az EBF-ről, hogy milyen felháborító, hogy előzetes bejelentés
nélkül törnek be a kórházba, meg hogy intézményeket bírságolnak meg… ma
meg egyes orvosokat (nem a kórházakat!) büntetnek meg azért, mert nem
volt rajtuk névtábla, érdekes módon erről ugyanazok a lapok nem írnak
cikkeket, amik 2009-ben fel voltak háborodva az EBF tevékenységén.)

És mindezt 15 évvel ezelőtt. 15 év telt az EBF megszüntetése óta, és
azóta nemhogy a 15 évvel ezelőtti lehetőségeket nem sikerült újra
...
Miután 15 *évig* nem történt semmi.)
...
A felvezetőben említettem, hogy a diagnosztikai infrastruktúráról az
ágyszám- és betegforgalmi kimutatások nem adnak információt (lévén, hogy
ezekhez nem tartozik ágy), noha ezek kritikus elemei a kórházi
ellátásnak – aligha képzelhető el kórház röntgen vagy labor nélkül.
Szerencsére azonban ezen infrastruktúra egy részéről, jelesül a
képalkotókról – tételesen: a CT-, MRI- és PET-berendezésekről – van
információnk. Egész pontosan kétféle információ érhető el, és mindkettő
érdekes lehet: a berendezések darabszáma, és az elvégzett vizsgálatok
száma.

Mielőtt a részletekre kitérünk, beszéljünk picit az adatforrásokról. A
NEAK minden évben
[kiad](https://www.neak.gov.hu/felso_menu/rolunk/kozerdeku_adatok/gazdalkodasi_adatok/statisztikai_kiadvanyok)
egy ún. Statisztikai Évkönyvet, aminek van CT/MRI-ről szóló pontja. Az
országos adatok tartalmazzák a vizsgálatok számát, az elektronikus
mellékletben elérhető megyesoros adatok pedig a készülékek számát is.
(Azt nem értem, hogy ez utóbbi miért nincsen szerepeltetve az országos
adatok között; ott csak a finanszírozott szolgáltatók számáról van adat,
ami nekünk nem sokat segít, hiszen nem tudni, hogy egy szolgáltatóhoz
hány gép tartozik.) Az országos adathoz tartozó módszertani leírás
rögzíti, hogy az ott szereplő adat, tehát a vizsgálatok száma, csak az
[1-es térítési kategória](https://njt.hu/jogszabaly/1999-43-20-22)
(„magyar biztosítás alapján végzett térítésmentes ellátás”) adatait
tartalmazzák. Mivel a „fekvő beteg részére végzett ellátás” egy másik
térítési kategória (6-os kód), így értelmezésem szerint ez a szám a
vizsgálatok egy lényeges hányadát nem tartalmazza, hiszen a
fekvőbetegeken végzett vizsgálatok nincsenek benne. A megyesoros
adatokhoz nem tartozik módszertani leírás, így ott nincs pontos
definíciónk. A dolog ott válik érdekessé, ha mindehhez hozzátesszük,
hogy ilyen adatok – mindkét típus – az Eurostat-nál is elérhető. Az
ottani leírás szerint az adatszolgáltatójuk a NEAK, de az adatok mégsem
egyeznek egymással. Hogy pontos legyek: a vizsgálatok száma nagyobb; azt
gondolom, hogy ez megerősíti a feltételezésemet arról, hogy a NEAK-nál
nincsenek benne a fekvőbetegek részére végzett vizsgálatok. Az Eurostat
[módszertani
leírása](https://ec.europa.eu/eurostat/cache/metadata/EN/hlth_res_esms_hu.htm)
ugyanis úgy fogalmaz, hogy a közölt adat azon vizsgálatok száma, amit a
NEAK finanszíroz; értelmezésem szerint ebben a fekvő betegek részére
végzett vizsgálatok is benne vannak, a szám ezért nagyobb. (De még így
is csak a közfinanszírozott ellátásokat tartalmazza – nézőpont kérdése,
hogy ez mennyire limitáció, lehet éppenséggel a mellett is érvelni, hogy
az állam által működtetett egészségügyi infrastruktúra megítéléshez pont
hogy ez számít.) A készülékek számára közölt adat az Eurostat-nál
pontosan ugyanaz, mint a NEAK Statisztikai Évkönyvében. Ez azért nagyon
fontos, mert mint említettem, a NEAK-nál ehhez nem volt módszertani
leírás – de az Eurostat-nál van! Így kiderül, hogy ez a szám mit jelent:
azon túl, hogy itt is csak a közfinanszírozott ellátást nyújtó gépek
vannak feltüntetve, van egy nagyon komoly limitáció: nem jelennek meg a
...
magyar adat kevesebb lehet, mint a valós, még úgy is, hogy csak a
közfinanszírozott ellátást tekintjük. E problémára sajnos nem találtam
megoldást.
...
lelhetőek fel, ezzel együtt is, helyesebb ha úgy fogalmazunk, hogy most
a magyar egészségügyi ellátórendószer egészéről (és nem a kórházi
rendszerről) nyilatkozunk.

Nézzük most először a készülékek számát! Kezdjük az aktuális
helyzetképpel (a 2023-as adatot használom, mert a 2024-es még nagyon
hiányos):
...
helyzet az évtizedek alatt javult és folyamatosan javul, nem eléggé
ahhoz, hogy elmozdítson minket az utolsó helyről. Egyedül PET terén
állunk nagyon kicsit jobban.

Szinte levegőt se veszek és rögtön mondom, hogy ez az a mérőszám, amire
végképp igaz, hogy nem lehet úgy értelmezni, mint a szocialista stílusú
„100 ezer lakosra jutó cementgyártás” példáját, tehát, hogy minél több,
annál jobb. A sürgősségi ellátástól eltekintve voltaképp a gépek száma
mindegy is, hiszen a betegnek az ellátórendszer kapacitása a kérdés,
márpedig azt nem a gépek, hanem a *vizsgálatok* száma jelenti. Amivel a
beteg szembesül, hogy mennyi kapacitása van számára a rendszernek, az
azon múlik, hogy hány vizsgálatot tudunk elvégezni, nem azon, hogy hány
gépünk van. Ami nagyon nem ugyanaz, hiszen az egy év alatt egy gépre
jutó vizsgálatok száma egyáltalán nem biztos, hogy ugyanaz az egyes
országokban.

Ha valaki kevesebb gépből is több vizsgálatot tud kihozni, az nemhogy
nem baj, hanem kimondottan jó hír: ezek a gépek rettenetesen drágák,
nagy tőkelekötést jelentenek, így ha az ember egyszer már megvette őket,
akkor az a racionális, ha minél többet dolgoznak. Annál nincs drágább,
mintha megvettük a gépet nagyon sok pénzért, aztán áll és nem dolgozik,
vagyis új gépet addig nem szabad venni, amíg a meglevőknek van szabad
kapacitása. Elméletileg az lenne az ideális, ha – a karbantartásoktól
eltekintve – minden percben folyamatosan dolgoznának, és csak akkor
vennék a meglevők mellé egy újabbat, ha az összes eddigi már 100%-os
kihasználtsággal működik.

A gépek száma mindössze két szempontból érdekes, az egyik a reduncia, ha
...
CT-ben pedig egyenesen a lista tetején! (Azaz hatékonyabbak vagyunk:
sokkal jobb egy CT-berendezésre jutó vizsgálat-számot produkálunk.)

Akkor ez már tényleg a tökéletes mutató? Sajnos ez sem teljesen, egy
szempontot ugyanis még ez is figyelmen kívül hagy: az igényt. Nem lehet
azt mondani, hogy ha egy országban 10 vizsgálatot végeznek, egy másikban
meg 100-at, akkor az utóbbiban jobb a helyzet – mi van, ha az előbbiben
10-re van igény is, de az utóbbiban 1000-re? Nagyon is elképzelhetőek
különbségek országok között az igényben, gondoljunk csak arra, hogy egy
sor rákbetegség igényel képalkotó vizsgálatot, márpedig a rák
előfordulása nagyon eltérhet országok között. Ezt kicsit továbbgondolva
hamar eljutunk oda, hogy mi lenne az ideális mérőszám: egyszerűen azt
kellene tudni, hogy a vizsgálatokon történő sorra kerülés ideje mennyi
(természetesen ahhoz viszonyítva, mint amit az adott eset orvosi
sürgőssége indokol!). Ha mindenkit meg tudunk egy órán belül CT-zni,
akit orvosilag indokolt egy órán belül, mindenkit egy napon belül, akit
orvosilag indokolt egy napon belül, mindenkit egy héten belül, akit
orvosilag indokolt egy héten belül stb. akkor elég CT-készülék van, ha
nem, akkor nincs – *függetlenül* attól, hogy mennyi a vizsgálatok száma
(és pláne függetlenül attól, hogy mennyi a gépek száma). Sajnos erre
vonatkozó nyilvános adatról nem tudok.
...
kimutatások adatai értékesek és érdekesek, másrészt, hogy közben egy
nagyon fontos feladat, a teljesítménymérés megoldásához még nem tudjuk
ezeket használni. Ehhez további adatokra volna szükség; de remélem meg
tudtam mutatni azt is, hogy ez alapvető fontosságú lenne a magyar
egészségügy fejlesztéséhez. Nem kis feladat – de megoldható. A szűk
keresztmetszet ehhez, úgy hiszem, nem a módszertan, hanem a politikai
szféra támogatása.
...
A [szerző](https://www.medstat.hu/) klinikai biostatisztikus,
